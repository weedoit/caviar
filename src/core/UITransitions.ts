...
module Caviar {
    ...
    export module UITransitions {
         ...
         */
        export function register (name, transitionIn, transitionOut) {
         ...
         */
        export function transitionIn (active, next, effect, callback) {
         ...
         * @param  {Function} callback Callback called when all itens of sequence was done.
         */
        export function transitionOut (active, prev, effect, callback) {
